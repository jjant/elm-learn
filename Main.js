...
function _Platform_export_UNUSED (exports) {
  window['Elm']
    ? _Platform_mergeExportsProd(window['Elm'], exports)
    : (window['Elm'] = exports)
}
...
function _Platform_export (exports) {
  window['Elm']
    ? _Platform_mergeExportsDebug('Elm', window['Elm'], exports)
    : (window['Elm'] = exports)
}
    ...
    A2(
      ...
      _List_fromArray([
        ...
        A2(
          ...
          _List_fromArray([$elm$html$Html$text('custom types')])
        ),
...
var $elm$browser$Debugger$Overlay$viewShape = F4(function (
  x,
  y,
  angle,
  coordinates
...
var $elm$browser$Debugger$Overlay$elmLogo = A4(
  ...
  _List_fromArray([
    A4(
      ...
      _List_fromArray([
        A4(
          $elm$browser$Debugger$Overlay$viewShape,
          0,
          -210,
          0,
          '-280,-90 0,190 280,-90'
...
var $elm$browser$Debugger$Main$DragInfo = F5(function (
  x,
  y,
  down,
  width,
...
var $elm$browser$Debugger$Main$decodeDimension = function (field) {
  return A2(
    ...
    _List_fromArray(['currentTarget', 'ownerDocument', 'defaultView', field]),
...
var $elm$browser$Debugger$Main$viewExpando = F3(function (
  expandoMsg,
  expandoModel,
  layout
) {
  ...
  return A2(
    ...
    _List_fromArray([
      A2(
        ...
        _List_fromArray([$elm$html$Html$text('-- MESSAGE')])
      ),
      A2(
        $elm$html$Html$map,
...
var $elm$browser$Debugger$History$showMoreButton = function (numMessages) {
  var nextIndex =
    numMessages - 1 - $elm$browser$Debugger$History$maxSnapshotSize * 2
  ...
  return A2(
    ...
    _List_fromArray([
      A2(
        ...
        _List_fromArray([$elm$html$Html$text(labelText)])
      ),
      A2(
        $elm$html$Html$span,
        _List_fromArray([
...
var $elm$browser$Debugger$History$consSnapshot = F3(function (
  ...
  var selectedIndexHelp =
    _Utils_cmp(nextIndex, selectedIndex) > 0 &&
    _Utils_cmp(selectedIndex, index) > -1
      ? selectedIndex
      : -1
  return _Utils_Tuple2(
    nextIndex,
...
var $elm$browser$Debugger$History$viewAllSnapshots = F3(function (
  selectedIndex,
  startIndex,
  snapshots
) {
...
var $elm$browser$Debugger$History$viewRecentSnapshots = F3(function (
  selectedIndex,
  recentMessagesNum,
  snapshots
) {
  var messagesToFill =
    $elm$browser$Debugger$History$maxSnapshotSize - recentMessagesNum
  ...
  var startingIndex =
    arrayLength * $elm$browser$Debugger$History$maxSnapshotSize -
    $elm$browser$Debugger$History$maxSnapshotSize -
    messagesToFill
  return A3(
    $elm$browser$Debugger$History$viewAllSnapshots,
    selectedIndex,
    startingIndex,
    snapshotsToRender
  )
...
var $elm$browser$Debugger$History$view = F2(function (maybeIndex, _v0) {
  ...
  var onlyRenderRecentMessages =
    !_Utils_eq(index, -1) || $elm$core$Array$length(snapshots) < 2
  var oldStuff = onlyRenderRecentMessages
    ? A4(
        $elm$html$Html$Lazy$lazy3,
        $elm$browser$Debugger$History$viewAllSnapshots,
        index,
    ...
    : A4(
        $elm$html$Html$Lazy$lazy3,
        $elm$browser$Debugger$History$viewRecentSnapshots,
        index,
        recent.numMessages,
        snapshots
      )
  ...
  return A4(
    ...
    _List_fromArray([
      A4(
        ...
        'http://www.w3.org/2000/svg',
        'path',
        _List_fromArray([A2($elm$virtual_dom$VirtualDom$attribute, 'd', path)]),
        _List_Nil
      )
    ])
  )
}
var $elm$browser$Debugger$Main$viewHistoryButton = F3(function (
  label,
  msg,
  path
) {
...
var $elm$html$Html$Attributes$min = $elm$html$Html$Attributes$stringProperty(
  'min'
)
...
var $elm$browser$Debugger$Main$viewPlayButton = function (playing) {
  return A2(
    ...
    _List_fromArray([
      playing
        ? $elm$browser$Debugger$Main$icon(
            'M2 2h4v12h-4v-12z M10 2h4v12h-4v-12z'
          )
        : $elm$browser$Debugger$Main$icon('M2 2l12 7l-12 7z')
    ])
  )
}
var $elm$browser$Debugger$Main$viewHistorySlider = F2(function (
  history,
  maybeIndex
) {
...
var $elm$browser$Debugger$Main$viewHistory = F3(function (
  maybeIndex,
  history,
  layout
) {
  ...
  return A2(
    ...
    _List_fromArray([
      ...
      A2(
        $elm$html$Html$Lazy$lazy,
        $elm$browser$Debugger$Main$viewHistoryOptions,
        layout
      )
    ])
  )
...
var $elm$browser$Debugger$Main$popoutView = function (model) {
  ...
  return A3(
    ...
    _List_fromArray([
      A3(
        $elm$browser$Debugger$Main$viewHistory,
        maybeIndex,
        historyToRender,
        model.layout
      ),
      ...
      A3(
        $elm$browser$Debugger$Main$viewExpando,
        model.expandoMsg,
        model.expandoModel,
        model.layout
      )
  ...
  switch (expando.$) {
    ...
    default:
      ...
      return isOuter
        ...
        ? A3($elm$browser$Debugger$Expando$Constructor, maybeName, false, args)
        : expando
  }
})
  ...
  return _Utils_Tuple2(
    {
      ...
      layout: A3(
        $elm$browser$Debugger$Main$Horizontal,
        $elm$browser$Debugger$Main$Static,
        0.3,
        0.5
      ),
...
var $elm$core$Array$unsafeReplaceTail = F2(function (newTail, _v0) {
  ...
  if (_Utils_eq(newTailLen, $elm$core$Array$branchFactor)) {
    var overflow =
      _Utils_cmp(newArrayLen >>> $elm$core$Array$shiftStep, 1 << startShift) > 0
    if (overflow) {
...
var $elm$browser$Debugger$Metadata$checkUnion = F4(function (
  ...
  var tagChanges = A6(
    ...
    old.tags,
    _new.tags,
    $elm$browser$Debugger$Report$emptyTagChanges(_Utils_eq(old.args, _new.args))
  )
...
var $elm$browser$Debugger$Metadata$checkTypes = F2(function (old, _new) {
  return !_Utils_eq(old.message, _new.message)
    ? A2($elm$browser$Debugger$Report$MessageChanged, old.message, _new.message)
...
var $elm$browser$Debugger$History$elmToJs = A2(
  $elm$core$Basics$composeR,
  _Json_wrap,
  _Debugger_unsafeCoerce
)
...
var $elm$browser$Debugger$Main$drag = F2(function (info, layout) {
  if (layout.$ === 'Horizontal') {
    ...
    var x = layout.b
    return A3(
      $elm$browser$Debugger$Main$Vertical,
      status,
      x,
      info.y / info.height
    )
...
var $elm$browser$Debugger$History$jsToElm = A2(
  $elm$core$Basics$composeR,
  _Json_unwrap,
  _Debugger_unsafeCoerce
)
    ...
    switch (msg.$) {
      ...
      case 'Up':
        ...
        if (_v4.$ === 'Running') {
          ...
          if (
            _Utils_cmp(
              targetIndex,
              $elm$browser$Debugger$History$size(history)
            ) < 0
          ) {
            var $temp$update = update,
      ...
      case 'DragStart':
        return _Utils_Tuple2(
          _Utils_update(model, {
            layout: A2(
              $elm$browser$Debugger$Main$setDragStatus,
              $elm$browser$Debugger$Main$Moving,
              model.layout
            )
          }),
          $elm$core$Platform$Cmd$none
  ...
  Main: {
    init: $author$project$Main$main(
      ...
      types: {
        ...
        aliases: {},
        unions: {
          'Main.Msg': { args: [], tags: { Increment: [], Decrement: [] } }
        }
      }
    })
  }
