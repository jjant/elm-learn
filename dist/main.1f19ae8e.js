...
var $elm$lel$Main$initApp = function (_v0) {
	return _Utils_Tuple2(
		{},
		$elm$core$Platform$Cmd$none);
};
var $elm$lel$Main$OnNumber = function (a) {
	return {$: 'OnNumber', a: a};
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$lel$Main$MySub = function (a) {
	return {$: 'MySub', a: a};
};
var $elm$lel$Main$init = $elm$core$Task$succeed(
	{sentNumber: false});
var $elm$core$Debug$log = _Debug_log;
var $elm$lel$Main$sendNumber = F2(
	function (router, _v0) {
		var tagger = _v0.a;
		return A2(
			$elm$core$Task$map,
			function (_v1) {
				return {sentNumber: true};
			},
			A2(
...
var $elm$lel$Main$onEffects = F3(
	function (router, subs, state) {
		var _v0 = A2($elm$core$Debug$log, 'state', state);
		var _v1 = A2($elm$core$Debug$log, 'subs', subs);
		return A3(
			$elm$core$List$foldl,
			F2(
				function (sub, bigTask) {
					return A2(
						$elm$core$Task$andThen,
						function (modifiedState) {
							return (!modifiedState.sentNumber) ? A2($elm$lel$Main$sendNumber, router, sub) : $elm$core$Task$succeed(state);
						},
						bigTask);
				}),
...
var $elm$lel$Main$onSelfMsg = F3(
	function (router, newTime, state) {
		return $elm$core$Task$succeed(state);
	});
var $elm$lel$Main$subMap = F2(
	function (func, sub) {
		var tagger = sub.a;
		return $elm$lel$Main$MySub(
			A2($elm$core$Basics$composeL, func, tagger));
	});
_Platform_effectManagers['Main'] = _Platform_createManager($elm$lel$Main$init, $elm$lel$Main$onEffects, $elm$lel$Main$onSelfMsg, 0, $elm$lel$Main$subMap);
var $elm$lel$Main$subscription = _Platform_leaf('Main');
var $elm$lel$Main$mySub = function (msg) {
	return $elm$lel$Main$subscription(
		$elm$lel$Main$MySub(msg));
};
var $elm$lel$Main$subscriptionsApp = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$elm$lel$Main$mySub($elm$lel$Main$OnNumber)
			]));
};
var $elm$lel$Main$updateApp = F2(
	function (msg, model) {
		var number = msg.a;
		var _v1 = A2($elm$core$Debug$log, 'received', number);
		return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
	});
var $elm$lel$Main$viewApp = function (model) {
	return $elm$html$Html$text('hey');
};
var $elm$lel$Main$main = $elm$browser$Browser$element(
	{init: $elm$lel$Main$initApp, subscriptions: $elm$lel$Main$subscriptionsApp, update: $elm$lel$Main$updateApp, view: $elm$lel$Main$viewApp});
_Platform_export({'Main':{'init':$elm$lel$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"OnNumber":["Basics.Int"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});
...
},{"./Main.elm":"Main.elm"}],"../../../.npm/_npx/81076/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../.npm/_npx/81076/lib/node_modules/parcel/src/builtins/hmr-runtime.js","main.js"], null)
